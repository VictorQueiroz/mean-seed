...
angular.module("app", [ "ngRoute", "ngAnimate", "app.routes", "app.controllers", "app.filters", "app.directives", "app.services", "partials", "ui.bootstrap", "mgcrea.ngStrap" ]), 
...
} ]), angular.module("user.ctrl.user-detail", [ "ngRoute", "user.service" ]).controller("UserDetailCtrl", [ "$scope", "$routeParams", "User", function($scope, $routeParams, User) {
    $scope.user = User.get({
        id: $routeParams.id
    });
} ]), angular.module("user.ctrl.user-list", [ "user.service" ]).controller("UserListCtrl", [ "$scope", "User", function($scope, User) {
    $scope.users = User.list();
} ]), angular.module("user.controllers", [ "user.ctrl.auth", "user.ctrl.user-list", "user.ctrl.user-detail" ]), 
angular.module("user.routes", [ "user.ctrl.auth" ]).config([ "$routeProvider", function($routeProvider) {
...
} ]), angular.module("user.services", [ "ngResource", "user.service" ]);