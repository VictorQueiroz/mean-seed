...
angular.module("Auth/Service", [ "ngCookies", "Session" ]).factory("AuthService", [ "$cookieStore", function() {} ]), 
angular.module("Auth/Directive/IfAuthenticated", [ "Session/Service" ]).directive("ifAuthenticated", [ "Session", function(Session) {
    return {
...
} ]), angular.module("Session", [ "Session/Service" ]), angular.module("User/Ctrl/Auth", [ "App/Services" ]).controller("AuthCtrl", [ "$scope", "$http", "$alert", "$socket", function($scope, $http, $alert, $socket) {
...
} ]), angular.module("User/Controllers", [ "User/Ctrl/Auth", "User/Ctrl/UserList", "User/Ctrl/UserDetail" ]), 
