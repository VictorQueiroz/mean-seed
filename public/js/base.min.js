...
angular.module("Auth/Service", [ "ngCookies" ]).factory("AuthService", [ "$cookieStore", function() {} ]), 
angular.module("Auth/Directives", []), angular.module("Auth", [ "ngRoute", "Auth/Service" ]).run([ "$rootScope", function($rootScope) {
